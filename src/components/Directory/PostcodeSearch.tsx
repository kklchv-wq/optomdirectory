      ...
      <form onSubmit={handlePostcodeSubmit} className="flex items-center gap-1.5 w-full">
        <div className="relative flex-1 min-w-[140px]">
          ...
          <input
            ...
            className="w-full pl-8 pr-3 py-1.5 bg-white border border-slate-300 rounded-xl text-xs sm:text-sm text-slate-900 placeholder-slate-400 focus:outline-hidden focus:ring-2 focus:ring-teal-500/20 focus:border-teal-500 font-mono uppercase shadow-2xs font-semibold tracking-wide"
        ...
        <div className="flex items-center gap-1.5 shrink-0">
          <button
            ...
            disabled={geoLoading}
            className="inline-flex items-center justify-center gap-1 px-2.5 sm:px-3 py-1.5 bg-white hover:bg-slate-100 text-slate-700 font-bold text-xs rounded-xl border border-slate-200 transition-colors disabled:opacity-50 focus:outline-hidden cursor-pointer shadow-2xs shrink-0"
          >
            {geoLoading ? (
            ...
            <span className="hidden xs:inline sm:inline">Near Me</span>
          </button>

          <button
            type="submit"
            disabled={loading || !postcode.trim()}
            className="inline-flex items-center justify-center px-3.5 py-1.5 bg-teal-700 hover:bg-teal-800 text-white font-bold text-xs rounded-xl transition-colors disabled:opacity-50 disabled:cursor-not-allowed focus:outline-hidden cursor-pointer shadow-2xs shrink-0"
          >
